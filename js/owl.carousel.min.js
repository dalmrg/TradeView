!function(a, b, c, d) {
    function e(b, c) {
        ...
        , e.Defaults, c), this.$element=a(b), this.drag=a.extend( {}
    ...
    , e.Defaults= {
        items:3, loop:!1, center:!1, mouseDrag:!0, touchDrag:!0, pullDrag:!0, freeDrag:!1, margin:0, stagePadding:0, merge:!1, mergeFit:!0, autoWidth:!1, startPosition:0, rtl:!1, smartSpeed:250, fluidSpeed:!1, dragEndSpeed:!1, responsive: {}
    ...
    , {
        filter:["width", "items", "settings"], run:function() {
            ...
            c>b;
            b++)e.width=Math.abs(this._coordinates[b])-Math.abs(this._coordinates[b-1]||0)-this.settings.margin, this.$stage.children().eq(b).css(e);
    ...
    , e.prototype.setup=function() {
        ...
        , this.options), (null===this.settings||this._breakpoint!==d)&&(this.trigger("change", {
            property: {
...
(window.Zepto||window.jQuery, window, document), function(a, b, c) {
    var d=function(b) {
        ...
        , this._core.options=a.extend( {}
        , d.Defaults, this._core.options), this._core.$element.on(this._handlers), this._core.$element.on("click.owl.video", ".owl-video-play-icon", a.proxy(function(a) {
            this.play(a)
        }
        , this))
    }
...
(window.Zepto||window.jQuery, window, document), function(a, b, c) {
    var d=function(b) {
        this.core=b, this.core.options=a.extend( {}
        , d.Defaults, this.core.options), this.handlers= {
...
(window.Zepto||window.jQuery, window, document), function(a) {
    ...
    var b=function(c) {
        ...
        , this._core.options=a.extend( {}
        , b.Defaults, this._core.options), this.$element.on(this._handlers)
    }
    ;
    b.Defaults= {
...
(window.Zepto||window.jQuery, window, document), function(a, b) {
    ...
    var c=function(d) {
        ...
        , this._core.options=a.extend( {}
        , c.Defaults, this._core.options), this.$element.on(this._handlers), a(b).on("hashchange.owl.navigation", a.proxy(function() {
